...
public class Exam0460 {
  ...
  static int sum(int value,int value1,int value2,int value3,int value4) {
    System.out.println(value);
    if (value == 1)
      return 1;

    return value + sum(value - 1,value1,value2,value3,value4);
  }
  ...
  public static void main(String[] args) {
    ...
    System.out.println(sum(10000,1000,100,1));
